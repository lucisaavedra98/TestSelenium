...
public class PruebaDriverME {

	public static void main(String[] args) {
		DriverSeleniumInternetExplorer driver = new DriverSeleniumInternetExplorer();
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menuform:um_messages")));
		action.moveToElement(driver.getDriver().findElement(By.id("menuform:um_messages")));
		action.click();
		action.perform();
